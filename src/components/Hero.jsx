...
import {HeroSection2,bM,HeroSection,hotelbg} from '../assets'
      ...
      <img 
         ...
         <div className='absolute inset-0 flex items-center justify-center p-12 mt-12'>
          ...
          whileInView="show" className='text-center'>
            ...
            <h1 className='md:text-[5.5em] text-[3em] items-center text-white mb-4 font-Montserrat font-black leading-tight'>
